<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="Yemek_Tarifi_Sitesi.AnaSayfa" %>
            ...
            <table class="auto-style7">
                <tr>
                    <td class="auto-style9"><strong>
                        ...
                        <asp:Label ID="Label4" runat="server" CssClass="auto-style13" Text='<%# Eval("YemekAd") %>'></asp:Label></a>
                        </strong></td>
                </tr>
                <tr>
