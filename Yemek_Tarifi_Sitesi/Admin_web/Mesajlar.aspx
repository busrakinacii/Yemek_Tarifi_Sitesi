<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_web/Admin.Master" AutoEventWireup="true" CodeBehind="Mesajlar.aspx.cs" Inherits="Yemek_Tarifi_Sitesi.Admin_web.Mesajlar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style17" __designer:mapid="835">
        <tr __designer:mapid="836">
            ...
            <td __designer:mapid="83d" class="auto-style16"><strong>MESAJLAR LİSTESİ</strong></td>
        </tr>
    </table>
        ...
        <table class="auto-style7">
            <tr>
                ...
                <td class="auto-style11">
                  ...
                  <asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/icons/Received.png" Width="30px" /></a>
                </td>
            </tr>
        </table>
    </ItemTemplate>
